...
const HowIStartedCoding = () => {
  ...
  return (
    <div>
      <Navbar />
      <BlogIntro title="How I started coding" date="09/01/2022" />
      <Container>
        {content.map((paragraph, index) => (
          <Paragraph content={paragraph} key={index} />
        ))}
        <Outro />
      </Container>
      <Footer />
...
export default HowIStartedCoding;
